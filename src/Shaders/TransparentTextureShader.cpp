...
#include "TransparentTexturedPS.h"
...
TransparentTextureShader::~TransparentTextureShader() NOEXCEPT
{
  // destructor
  this->clear();
}

const glm::mat4 TransparentTextureShader::getInstanceData(
...
const TransparentTextureShader::Instance
TransparentTextureShader::createInstanceUnit(
...
void TransparentTextureShader::executeShader(const Instance& instance) const
{
...
TransparentTextureShader::InstanceFinder::InstanceFinder(MeshObject* gameObject)
    : object(gameObject)
{
}

const bool TransparentTextureShader::InstanceFinder::operator()(
...
TransparentTextureShader::ObjectFinder::ObjectFinder(MeshObject* gameObject)
    : instance(gameObject)
{
}

const bool TransparentTextureShader::ObjectFinder::operator()(
...
const bool TransparentTextureShader::InstanceSorter::operator()(
    const Instance& lhs, const Instance& rhs)
{
  return lhs.textureId < rhs.textureId and lhs.meshId < rhs.meshId;
}

const bool TransparentTextureShader::initialise()
{
  this->clear();
  ...
  unsigned pixelShaderId = resourceManager->compileShaderCode(
      TransparentTexturedPS, TransparentTexturedPS_size, PIXEL_SHADER);
...
void TransparentTextureShader::prepare()
{
...
void TransparentTextureShader::clear() { this->instances.clear(); }

void TransparentTextureShader::addInstance(IGameObject* instance)
{
  instance->addInstance(this);
}

void TransparentTextureShader::addInstance(MeshObject* instance)
{
...
void TransparentTextureShader::render()
{
  std::vector<Instance>::iterator instanceEnd = this->instances.end();
  std::vector<Instance>::iterator instanceIterator;
...
void TransparentTextureShader::updateData(std::vector<MeshObject*>& gameObjects,
